...
export function SaveRequestDialog({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'bg-white dark:bg-[#1e1e1e] w-full max-w-lg rounded-xl shadow-float dark:shadow-floatDark border border-ui-border dark:border-[#333] flex flex-col overflow-visible transform scale-95 transition-transform duration-200',
